"""
Django settings for fc_barca project.
...
ASGI_APPLICATION = 'fc_barca.asgi.application'
...
CHANNELS_WS_PROTOCOLS = ["websocket.auth"]
...
WSGI_APPLICATION = 'fc_barca.wsgi.application'
